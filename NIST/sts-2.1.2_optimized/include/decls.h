...
BitSequence *byteEpsilon;           // BIT STREAM IN BYTES
...
char	testNames[NUMOFTESTS+1][32] = { " ", "Frequency", "BlockFrequency", "CumulativeSums", "Runs", "LongestRun", "Rank",
			...
			"RandomExcursionsVariant", "Serial", "LinearComplexity", "DeviationMeasureI" , "DeviationMeasureII", "DeviationMeasureICS" ,"DeviationMeasureIICS",
            "OddHopSum", "EvenHopSum", "JumpComplexity", "SelfCorrelation", "BinaryDerivate", "PokerDetect", "RunsDistribution" };